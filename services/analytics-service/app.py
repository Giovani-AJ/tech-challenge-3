...
# Só usado em desenvolvimento local (docker-compose), pra apontar pro
# DynamoDB Local/SQS local em vez da AWS de verdade. Em produção fica vazio e
# o boto3 usa os endpoints reais da AWS normalmente.
